...
function PlannerHome() {
  ...
  useEffect(() => {
    ...
    async function getId() {
      try {
        const response = await axios.get("http://localhost:5000/planner/get-id", {
          withCredentials: true,
        });
    ...
    <>
      ...
      <div className="flex flex-col justify-center gap-6">
        ...
        <div>
          ...
          {events.length === 0 ? <div className="mb-3 font-normal text-gray-700 ">
                      ...
                      <div className="ml-2 max-w-sm p-6 bg-white border  border-gray-200 rounded-lg shadow">
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="flex gap-1">
                            Preferences:
                            {event.preferences.map((preference, index) => (
                              <span
                                key={index}
                          ...
                          >
                            {isApplied || event.planners.includes(Id)
                              ? "Applied"
                              : "Apply"}
                          </button>
                        </div>
